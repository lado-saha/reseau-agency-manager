...
export function TripDetailView({
  ...
  return (
    <div className="p-4">
      <Tabs
        value={tab}
        onValueChange={(value) => setTab(value as 'basic-info' | 'resource-info' | 'extra-info')}
      >
        ...
        <div className="flex items-center mt-2 mb-2">
          <TabsList>
            ...
            {originalTrip?.resources?.toSorted((a, b) => a.index - b.index).map((res, index) => {
              return (
                <TabsTrigger key={res.index} value="resource-info" className="items-center">
            ...
            {mode === 'edit-mode' && (
              <div>
                <DeleteDialog
                  ...
                  description={`Are you sure you want to cancel this trip?. Irreversible`}
                  onDeleteAction={() => {
